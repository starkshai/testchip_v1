...
sigma=[541 309 235 191 158 148 122 120 117 111];
err=[1/sqrt(923)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(1000)*sigma(3) ...
    1/sqrt(1000)*sigma(4) 1/sqrt(1000)*sigma(5) 1/sqrt(992)*sigma(6) ...
    1/sqrt(1000)*sigma(7) 1/sqrt(975)*sigma(8) 1/sqrt(1000)*sigma(9) 1/sqrt(998)*sigma(10)];
...
title('Board 3 T12 timing performance');