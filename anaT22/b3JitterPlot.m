...
sigma=[473 296 223 184 165 150 140 126 116 101];
err=[1/sqrt(986)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(1000)*sigma(3) ...
    1/sqrt(999)*sigma(4) 1/sqrt(1000)*sigma(5) 1/sqrt(1000)*sigma(6) ...
    1/sqrt(1000)*sigma(7) 1/sqrt(1000)*sigma(8) 1/sqrt(938)*sigma(9) 1/sqrt(944)*sigma(10)];
...
title('Board 3 T22 timing performance');