...
%for i=0:1:3
for i=10:1:13
    %f1=readmatrix(['v2board2\t22thd18v60f' num2str(i) '.csv']);
    f1=readmatrix(['v2board2\t22thd00v58f' num2str(i) '.csv']);
    flen=size(f1);
...
for i=1:(eventnumb-1)
    ...
    for j=1:1:65%152ns to 155ns window
...
SPEnumb=0;
for i=1:hitnumb
    if hitwidth(1,i)<30 && hitwidth(1,i)>5%SPE width
...
TOA1numb=0;
for i=1:SPEnumb
    if (hitSPE(1,i)>152.6) && (hitSPE(1,i)<154.5)%cut
        TOA1numb=TOA1numb+1;
