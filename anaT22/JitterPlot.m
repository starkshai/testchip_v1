...
sigma=[481 279 208 192 168 152 144 134 127 122];
err=[1/sqrt(992)*sigma(1) 1/sqrt(988)*sigma(2) 1/sqrt(972)*sigma(3) ...
    1/sqrt(993)*sigma(4) 1/sqrt(990)*sigma(5) 1/sqrt(982)*sigma(6) ...
    1/sqrt(991)*sigma(7) 1/sqrt(980)*sigma(8) 1/sqrt(981)*sigma(9) 1/sqrt(983)*sigma(10)];
...
title('Board 2 T22 timing performance');