...
sigma=[1127 365 220 167 142 123 114 118 107 99];
err=[1/sqrt(841)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(996)*sigma(3)...
     1/sqrt(969)*sigma(4) 1/sqrt(993)*sigma(5) 1/sqrt(978)*sigma(6)...
     1/sqrt(985)*sigma(7) 1/sqrt(991)*sigma(8) 1/sqrt(994)*sigma(9) 1/sqrt(995)*sigma(10)];
...
title('Version 2 board 2 T11 timing performance');