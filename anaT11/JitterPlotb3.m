...
sigma=[372 225 145 120 105 93 88 78 77];
err=[1/sqrt(885)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(983)*sigma(3)...
     1/sqrt(1000)*sigma(4) 1/sqrt(1000)*sigma(5) 1/sqrt(1000)*sigma(6)...
     1/sqrt(1000)*sigma(7) 1/sqrt(981)*sigma(8) 1/sqrt(999)*sigma(9)];
...
title('Board 3 T11 timing performance');