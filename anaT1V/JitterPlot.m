...
sigma=[339 180 137 109 92 90 86 77 74 70];
err=[1/sqrt(937)*sigma(1) 1/sqrt(968)*sigma(2) 1/sqrt(995)*sigma(3) ...
    1/sqrt(981)*sigma(4) 1/sqrt(974)*sigma(5) 1/sqrt(993)*sigma(6) ...
    1/sqrt(987)*sigma(7) 1/sqrt(993)*sigma(8) 1/sqrt(985)*sigma(9) 1/sqrt(981)*sigma(10)];
...
title('Board 2 T1V timing performance');