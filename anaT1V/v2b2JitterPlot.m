...
sigma=[428 204 145 119 106 101 95 84 83 75];
err=[1/sqrt(980)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(1000)*sigma(3) ...
    1/sqrt(1000)*sigma(4) 1/sqrt(1000)*sigma(5) 1/sqrt(1000)*sigma(6) ...
    1/sqrt(1000)*sigma(7) 1/sqrt(999)*sigma(8) 1/sqrt(995)*sigma(9) 1/sqrt(1000)*sigma(10)];
...
title('Version 2 board 2 T1V timing performance');