...
sigma=[340 228 166 148 139 130 116 111 106 102];
err=[1/sqrt(998)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(1000)*sigma(3) ...
    1/sqrt(1000)*sigma(4) 1/sqrt(1000)*sigma(5) 1/sqrt(1000)*sigma(6) ...
    1/sqrt(1000)*sigma(7) 1/sqrt(1000)*sigma(8) 1/sqrt(1000)*sigma(9) 1/sqrt(999)*sigma(10)];
...
title('Board 3 T1V timing performance');