...
sigma=[428 191 132 113 105 92 86 82 77 70];
err=[1/sqrt(952)*sigma(1) 1/sqrt(1000)*sigma(2) 1/sqrt(999)*sigma(3) ...
    1/sqrt(1000)*sigma(4) 1/sqrt(1000)*sigma(5) 1/sqrt(1000)*sigma(6) ...
    1/sqrt(1000)*sigma(7) 1/sqrt(1000)*sigma(8) 1/sqrt(1000)*sigma(9) 1/sqrt(1000)*sigma(10)];
...
title('Board 4 T1V timing performance');